...
C:\Users\r2com\.ssh>scp id_rsa.pub root@192.168.0.67:/root/.ssh/authorized_keys
```
...
```
C:\Users\r2com\.ssh>ssh -i my-key.pem root@192.168.0.67
```
...
```
C:\Users\r2com\.ssh>ssh root@192.168.0.67
root@192.168.0.67: Permission denied (publickey,gssapi-keyex,gssapi-with-mic).
```
...
![image-20220413183249352](md-images/0413/image-20220413183249352.png)

* ESTAB : 192.168.0.67:22                                192.168.0.26:64176
  * 서버 : 192.168.0.67:22
    * 포트 : 22 (고정)
...
```
C:\Users\r2com\.ssh>ssh -p 2222 -i my-key.pem root@192.168.0.67
...
![image-20220413184130235](md-images/0413/image-20220413184130235.png)
...
![image-20220413161704077](md-images/0413/image-20220413161704077.png)
...
C:\Users\r2com\.ssh> scp -i my-key.pem hello.txt root@192.168.0.67:/root/


- 역으로
C:\Users\r2com\.ssh> del hello.txt
C:\Users\r2com\.ssh> scp -i my-key.pem root@192.168.0.67:/root/hello.txt ./

C:\Users\r2com\.ssh> ssh -i my-key.pem root@192.168.0.67		/* 확인
# ls


- 폴더 (-r 옵션)
C:\Users\r2com\.ssh> copy hello.txt test-folder
C:\Users\r2com\.ssh> scp -i my-key.pem -r test-folder root@192.168.0.67:/root/

C:\Users\r2com\.ssh> ssh -i my-key.pem root@192.168.0.67		/* 확인
# ls
```

* 192.168.0.67 은 enp0s3 ip 주소
