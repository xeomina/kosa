...
* ECDSA key 와 함께 ip, domain 등을 known host에 저장



* "Failed to connect to the host via ssh: Warning: Permanently added '192.168 .1.48' (ECDSA) to the list of known hosts.\r\nAuthentication failed.",
...
* "Failed to connect to the host via ssh: Permission denied (publickey,gssapi-yex,gssapi-with-mic,password).",
